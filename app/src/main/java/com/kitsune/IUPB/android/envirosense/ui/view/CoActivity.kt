...
class CoActivity : AppCompatActivity() {
    ...
    private fun setBarChartData() {
        ...
        val dataSet = BarDataSet(entries, "CO")
    ...
    private fun setPieChartData() {
        ...
        val dataSet = PieDataSet(entries, "Distribución CO")
    ...
    private fun setLineChartData() {
        ...
        val dataSet = LineDataSet(entries, "CO")
    ...
    private fun setRadarChartData() {
        ...
        val dataSet = RadarDataSet(entries, "Datos Radar CO")
